...
public class HttpListenerPersistentConnections10TestCase extends HttpListenerPersistentConnectionsTestCase {
   ...
   * content to a 1.0 client. In this case, the only way for the server to indicate that the transmission of the content has finished is to
   * close the connection (and send the appropriate header indicating this) Although the "Transfer-encoding: Chunked" header is sent in the
   * response, the client should ignore it since it is not part of the 1.0 spec
   */
  @Test
