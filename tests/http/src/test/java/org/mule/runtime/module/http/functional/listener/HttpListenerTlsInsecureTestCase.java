...
/**
 * Sets up two HTTPS servers with regular trust-stores, except one is insecure. Verifies that a request using a certificate not present in
 * the trust-store only works for the insecure server.
 */
