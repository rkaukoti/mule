...
public class MethodEntryPointWithTransformerTestCase extends FunctionalTestCase {
  ...
  /**
   * Tests that a MethodEntryPointResolver is able to receive the method property from a MessagePropertyTransformer, that means that the
   * transformer is applied before resolving that property.
   */
  @Test
