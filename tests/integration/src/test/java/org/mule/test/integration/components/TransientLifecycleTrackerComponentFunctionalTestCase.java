...
public class TransientLifecycleTrackerComponentFunctionalTestCase extends FunctionalTestCase {
  ...
  /**
   * ASSERT: - Mule lifecycle methods invoked each time singleton is used to create new object in pool NOTE: injecting service/muleContext
   * only once since this is a pooled singleton
   */
  @Test
