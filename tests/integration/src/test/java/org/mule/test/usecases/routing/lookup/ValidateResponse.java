...
/**
 * Throws an exception if the message does not contain "success". In the real world, we might use XPath to extract a particular tag or error
 * code based on the expected response message format.
 */
