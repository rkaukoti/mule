...
public class MuleMavenMultiModuleArtifactMapping implements MavenMultiModuleArtifactMapping {
  ...
  /**
   * Creates a {@link MuleMavenMultiModuleArtifactMapping} and loads the mappings from
   * {@link MuleMavenMultiModuleArtifactMapping#MAVEN_MODULE_MAPPING_PROPERTIES}
   *
