...
public final class DependenciesFilter {
  ...
  /**
   * {@link Predicate} to be used to filter which dependencies should be included and used to traverse the tree in order to collect their
  ...
  /**
   * Sets the filter strategy to not include as part of the dependencies list resolved those dependencies that do match with the filter
   * defined here, but these dependencies should be used still to traverse the tree in order to collect their transitive dependencies A
   * frequently use case for this is, I would like to get all the transitive dependencies of one of my dependencies but I don't want the
   * dependency as part of the result.
   */
