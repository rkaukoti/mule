...
/**
 * Just extends {@link ClassPathClassifierContext} to append specific data needed to classify the context internally in {@link
 * MuleClassPathClassifier}.
 *
 * @since 4.0
 */
public class ExtendedClassPathClassifierContext
{
     ...
     *
     * @param classificationContext          the initial {@link ClassPathClassifierContext} context passed by {@link
