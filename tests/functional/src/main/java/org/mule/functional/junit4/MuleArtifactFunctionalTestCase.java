...
/**
 * Base class for mule functional test cases that run the test using class loading isolation. This class will set the default values for
 * testing mule components.
 * <p/>
...
@ArtifactClassLoaderRunnerConfig(extensionBasePackage = "org.mule.extension",
    exclusions = "org.mule:*:*," + "org.mule.modules*:*:*," + "org.mule.transports:*:*," + "org.mule.mvel:*:*," + "org.mule.common:*:*,")
