 ...
 * {@link org.junit.runner.Runner}. {@link ArtifactClassLoaderRunner} classifies the classpath provided by IDE/surfire-maven-plugin
 * generates an equivalent {@link ClassLoader} hierarchy as standalone mode.
 * <p/>
 ...
 * {@link org.mule.functional.classloading.isolation.maven.DependencyGraphMavenDependenciesResolver} for more details about how to generate
 * the dependency graph needed by this runner.
 * <p/>
 ...
 * and test to the application. For more information about the classification process see
 * {@link org.mule.functional.classloading.isolation.classification.ClassPathClassifier}.
 * <p/>
 * For plugins it will scan the plugin set of {@link java.net.URL}s to search for classes annotated with
 * {@link org.mule.runtime.extension.api.annotation.Extension}, if a class is annotated it will generate the metadata for the extension in
 * runtime and it will also register it to the {@link org.mule.runtime.extension.api.ExtensionManager}. Non extension plugins will set its
 ...
 * load extension classes (they are not exposed to the application) for registering them to the
