...
public class DependencyGraphMavenDependenciesResolver implements MavenDependenciesResolver {
  ...
  /**
   * Creates a dependency graph where with all the transitive dependencies, including duplicates. Uses depgraph-maven-plugin in order to
   * generate the dot graph and with the relationships (edges) it generates the {@link DependenciesGraph}.
   *
