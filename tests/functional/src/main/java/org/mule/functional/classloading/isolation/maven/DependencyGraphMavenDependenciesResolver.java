 ...
 * resolve the dependencies for the test class. It relies on the
 * {@link DependencyGraphMavenDependenciesResolver#DEPENDENCIES_GRAPH_FILE_NAME} generated by the depgraph-maven-plugin and the
 * artifact should have set this plugin in its maven build section and run it before the test is executed.
 * <p/>
