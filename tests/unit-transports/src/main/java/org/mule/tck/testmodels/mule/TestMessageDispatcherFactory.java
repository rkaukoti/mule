...
/**
 * A Test message dispatcher factory that is used for testing configuration loading since "test://" endpoints can be used instead of
 * bringing in other dependencies into Mule core
 */
