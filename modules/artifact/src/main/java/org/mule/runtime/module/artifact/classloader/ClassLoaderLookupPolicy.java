 ...
 * <p/>
 * Default lookup strategy is parent first. To use child-first, the corresponding package must be added as an overridden. To use child-only,
 * the corresponding package must be added as blocked.
 */
