...
/**
 * This class should be used when the same element can be configured as a child or an orphan (i.e., top-level). It will inject the bean into
 * the parent if the parent exists, otherwise it will not complain (ChildDefinitionParser throws an exception if no parent exists).
 */
