...
/**
 * This definition parser introduces the notion of Hierarchical processing to nested XML elements. Definition parsers that extend this can
 * refer to parent beans. It does not assume that the parser is restricted to a single property.
 * <p>
