...
/**
 * Responsible for passing in the MuleContext instance for all objects in the registry that want it. For an object to get an instance of the
 * MuleContext it must implement MuleContextAware.
 *
