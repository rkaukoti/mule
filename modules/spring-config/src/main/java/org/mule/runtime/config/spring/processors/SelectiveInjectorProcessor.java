...
/**
 * Base class for specializations of {@link MuleInjectorProcessor} which should only perform injection if a certain condition is met.
 *
 * @since 3.7.0
 */
abstract class SelectiveInjectorProcessor extends MuleInjectorProcessor {
  ...
  /**
   * Only performs the injetion if {@link #shouldInject(PropertyValues, PropertyDescriptor[], Object, String)} returns {@code true}
   * {@inheritDoc}
   */
  @Override
