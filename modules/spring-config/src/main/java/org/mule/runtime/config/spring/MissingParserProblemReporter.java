...
/**
 * A very simple extension to {@link org.springframework.beans.factory.parsing.FailFastProblemReporter} that intercepts errors related to
 * missing definition parsers to give a more helpful message. In the future we may want to replace this by something more sophisticated that
 * allows different problems to be resolved by different "pluggable" components...
 */
