 ...
 * This allows a named orphan to be defined (inherit="false") and then extended (inherit="true"). The two sub-parsers must be consistent, as
 * described in {@link org.mule.runtime.config.spring.parsers.delegate.AbstractParallelDelegatingDefinitionParser}
 */
