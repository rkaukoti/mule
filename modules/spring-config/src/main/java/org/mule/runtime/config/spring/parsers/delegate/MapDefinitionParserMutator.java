...
/**
 * This changes a {@link org.mule.runtime.config.spring.parsers.generic.ChildDefinitionParser} so that it generates a map instead of a bean
 * definition. This is useful for converting parsers to work with the object factory (which requires a map).
 */
