...
/**
 * Bean definition parser that allows mapping an element either as root or nested inside other element. Depending on the context, it
 * delegates to a {@code MuleOrphanDefinitionParser} or to a {@code ChildDefinitionParser}.
 */
