 ...
 *
 * During application config files processing all {@code ComponentBuildingDefinitionProvider} present in the classpath will be lookup to
 * search for available DSL parsing extensions.
 *
 * @since 4.0
 */
