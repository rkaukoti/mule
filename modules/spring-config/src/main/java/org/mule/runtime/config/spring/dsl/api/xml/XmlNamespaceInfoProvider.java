...
/**
 * Mule XML extensions needs to define a {@code} XmlNamespaceProvider in which they define the extensions namespace name and the extensions
...
public interface XmlNamespaceInfoProvider {
  ...
  /**
   * Most likely, hand made extensions will return a single value since they only provide support for a namespace but for other scenarios,
   * like extensions build with the SDK, it may provide several values.
   *
