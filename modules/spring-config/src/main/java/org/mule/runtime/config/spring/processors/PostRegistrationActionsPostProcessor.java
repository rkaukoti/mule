...
/**
 * A {@link BeanPostProcessor} which invokes {@link MuleRegistryHelper#postObjectRegistrationActions(Object)} after spring finishes
 * initialization over each object.
 *
 * @since 3.7.0
 */
public class PostRegistrationActionsPostProcessor implements BeanPostProcessor {
   ...
   * <p>
   * For instance, when a global transformer is defined, the post processing of it's creation will add it to the transformation service as
   * part of the transformation graph.
   * <p>
  ...
  public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
    // For now we don't process duplicate bean names. This is the case with <transformer ref="a"/> where the same bean is registered twice
    // by the old parsing mechanism.
