...
public interface DynamicAttributeDefinitionParser extends MuleDefinitionParser {
  ...
  /**
   * This is implemented in {@link org.mule.runtime.config.spring.parsers.AbstractHierarchicalDefinitionParser} and allows us to "fake" a
   * parent when processing the same element.
   */
