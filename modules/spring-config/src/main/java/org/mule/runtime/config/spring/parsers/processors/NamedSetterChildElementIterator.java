...
/**
 * This iterates over the child elements, generates beans, and sets them on the current bean via the setter given. So presumably there's
 * either a single child or the destination is a collection.
 *
 * <p>
