...
/**
 * Visitor that will be invoked based on a {@link org.mule.runtime.config.spring.dsl.api.ComponentBuildingDefinition#getTypeDefinition()}
 * configuration.
 *
 * @since 4.0
 */
public interface TypeDefinitionVisitor
{
     ...
     *
     * @param attributeName the name of the configuration attribute holding the type definition. Most likely a fully qualified java class
     *                      name.
     */
