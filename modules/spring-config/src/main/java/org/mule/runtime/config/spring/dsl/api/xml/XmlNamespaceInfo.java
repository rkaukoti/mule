...
public interface XmlNamespaceInfo {
  ...
  /**
   * A mule extension may support different xml versions. Each version must always have the same prefix and no other extension can have that
   * prefix. Mule core has http://www.mulesoft.org/schema/mule/core/ as prefix for all the possible versions of the namespace.
   *
