...
/**
 * This allows a definition parsers to be dynamically represented by different definition parsers, depending on the context. For example, a
 * single model may be defined across file - the first use defines the model and subsequent uses extend it (for this particular case, see
