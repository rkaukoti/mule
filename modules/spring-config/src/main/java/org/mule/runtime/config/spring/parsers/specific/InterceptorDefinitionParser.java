...
public class InterceptorDefinitionParser extends ChildDefinitionParser {
  ...
  public String getPropertyName(Element e) {
    ...
    if ("flow".equals(parentName) || "inbound".equals(parentName) || "endpoint".equals(parentName) || "inbound-endpoint".equals(parentName)
        || "outbound-endpoint".equals(parentName) || "async-reply".equals(parentName) || "processor-chain".equals(parentName)) {
