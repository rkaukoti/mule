...
public interface HttpAuthentication {
  ...
  /**
   * Adds authentication information to the request. This method will be executed before creating and sending the request. Implementations
   * will usually add some authentication header, but there is no restriction on this.
   *
  ...
  /**
   * Detects if there was an authentication failure in the response. After sending an HTTP request and creating an event with the response,
   * this method will be executed. If it returns false, the flow continues executing. If it returns true, the requester will try to send the
   * request again.
   *
