...
/**
 * Namespace handler for functional tests of this module. It adds the bean definition parser for the header element which is otherwise added
 * by the HttpNamespaceHandler form the HTTP transport (outside tests).
 */
