...
public class HttpMessageProcessorTemplateTestCase extends AbstractMuleTestCase {
  ...
  public void statusCodeOnFailures() throws Exception {
    ...
    HttpMessageProcessorTemplate httpMessageProcessorTemplate = new HttpMessageProcessorTemplate(testEvent, mock(MessageProcessor.class),
        responseReadyCallback, null, HttpResponseBuilder.emptyInstance(mock(MuleContext.class)));
