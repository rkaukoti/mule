...
public class OracleXmlType extends StructuredDbType
{
     ...
     * @throws java.lang.Exception if there is a problem while creating the {@link #ORACLE_XMLTYPE_CLASS} object ({@link
     *                             #ORACLE_XMLTYPE_CLASS} class is not found in the classpath, connection is closed, etc)
     */
