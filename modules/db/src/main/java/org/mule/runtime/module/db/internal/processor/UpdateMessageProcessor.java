 ...
 * <p/>
 * An update query can be an update, insert or delete query, or a stored procedure taking input parameters only and returning an update
 * count.
 * <p/>
...
public class UpdateMessageProcessor extends AbstractSingleQueryDbMessageProcessor {
  ...
  public UpdateMessageProcessor(DbConfigResolver dbConfigResolver, QueryResolver queryResolver, QueryExecutorFactory queryExecutorFactory,
