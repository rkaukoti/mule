...
public class StoredProcedureColumnTypesBuilder {
  ...
  public StoredProcedureColumnTypesBuilder() {
    ...
    columns.add(
        new ColumnMetadata(StoredProcedureParamTypeResolverTestCase.TYPE_COLUMN, StoredProcedureParamTypeResolver.TYPE_ID_COLUMN_INDEX));
    columns.add(
        new ColumnMetadata(StoredProcedureParamTypeResolverTestCase.NAME_COLUMN, StoredProcedureParamTypeResolver.TYPE_NAME_COLUMN_INDEX));
