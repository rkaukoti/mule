...
public class DynamicBulkUpdateMessageProcessorTestCase extends AbstractMuleTestCase {
  ...
  public void returnsDebugInfo() throws Exception {
    ...
    final DynamicBulkUpdateMessageProcessor dynamicBulkUpdateMessageProcessor = new DynamicBulkUpdateMessageProcessor(dbConfigResolver,
        queryResolver, null, NOT_SUPPORTED, Collections.singletonList(QueryType.UPDATE));
