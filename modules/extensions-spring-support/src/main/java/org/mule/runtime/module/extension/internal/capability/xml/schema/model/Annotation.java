...
public class Annotation extends OpenAttrs {
  ...
  @XmlElements({@XmlElement(name = "appinfo", type = Appinfo.class), @XmlElement(name = "documentation", type = Documentation.class)})
   ...
   * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the appinfoOrDocumentation property.
   * <p/>
   * <p/>
