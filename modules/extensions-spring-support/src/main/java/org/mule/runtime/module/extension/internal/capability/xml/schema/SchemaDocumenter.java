...
/**
 * Utility class that picks a {@link ExtensionDeclaration} on which a {@link ExtensionModel} has already been described and enriches such
 * description with the javadocs extracted from the extension's acting classes.
 * <p>
 * This is necessary because such documentation is not available on runtime, thus this class uses the annotation processor's AST access to
 * extract it
 *
 * @since 3.7.0
 */
final class SchemaDocumenter {
  ...
  /**
   * Sets the description of the given {@code declaration} and its inner configs and operations by extracting information of the AST tree
