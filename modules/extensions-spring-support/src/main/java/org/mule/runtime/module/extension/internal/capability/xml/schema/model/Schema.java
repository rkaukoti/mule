...
public class Schema extends OpenAttrs {
  ...
  @XmlElements({@XmlElement(name = "attribute", type = TopLevelAttribute.class), @XmlElement(name = "group", type = NamedGroup.class),
      @XmlElement(name = "notation", type = Notation.class), @XmlElement(name = "attributeGroup", type = NamedAttributeGroup.class),
   ...
   * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the includeOrImportOrRedefine property.
   * <p/>
   * <p/>
   ...
   * <p/>
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list
   * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the simpleTypeOrComplexTypeOrGroup
   * property.
   * <p/>
   * <p/>
   * For example, to add a new item, do as follows:
   ...
   * {@link NamedAttributeGroup } {@link TopLevelElement } {@link Annotation } {@link TopLevelComplexType } {@link TopLevelSimpleType }
   */
   ...
   * <p/>
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list
   * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the finalDefault property.
   * <p/>
   * <p/>
   * For example, to add a new item, do as follows:
   * 
   ...
   * <p/>
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list
   * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the blockDefault property.
   * <p/>
   * <p/>
   * For example, to add a new item, do as follows:
   * 
