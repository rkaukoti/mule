...
public class Redefine extends OpenAttrs {
  ...
  @XmlElements({@XmlElement(name = "simpleType", type = TopLevelSimpleType.class),
      ...
      @XmlElement(name = "attributeGroup", type = NamedAttributeGroup.class), @XmlElement(name = "group", type = NamedGroup.class),
   ...
   * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the annotationOrSimpleTypeOrComplexType
   * property.
   * <p/>
   * <p/>
