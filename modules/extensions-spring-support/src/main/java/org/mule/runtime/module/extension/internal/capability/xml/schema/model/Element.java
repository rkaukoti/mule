...
/**
 * The element element can be used either at the top level to define an element-type binding globally, or within a content model to either
 * reference a globally-defined element or type or declare an element-type binding locally. The ref form is not allowed at the top level.
 * <p/>
 * <p>
...
public abstract class Element extends Annotated {
   ...
   * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the identityConstraint property.
   * <p/>
   * <p/>
   ...
   * <p/>
   * <p/>
   * Objects of the following type(s) are allowed in the list {@link Keyref } {@link JAXBElement }{@code <}{@link Keybase }{@code >}
   ...
   * <p/>
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list
   * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the final property.
   * <p/>
   * <p/>
   * For example, to add a new item, do as follows:
   * 
   ...
   * <p/>
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list
   * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the block property.
   * <p/>
   * <p/>
   * For example, to add a new item, do as follows:
   * 
