...
public class RestrictionType extends Annotated {
  ...
  @XmlElementRefs({@XmlElementRef(name = "maxInclusive", namespace = "http://www.w3.org/2001/XMLSchema", type = JAXBElement.class),
   ...
   * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the facets property.
   * <p/>
   * <p/>
   ...
   * <p/>
   * <p/>
   * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link NumFacet }{@code >} {@link JAXBElement
   * }{@code <}{@link Facet }{@code >} {@link TotalDigits } {@link JAXBElement }{@code <}{@link Facet }{@code >} {@link Pattern }
   * {@link JAXBElement }{@code <}{@link Facet }{@code >} {@link JAXBElement }{@code <}{@link NoFixedFacet }{@code >} {@link JAXBElement
   * }{@code <}{@link NumFacet }{@code >} {@link WhiteSpace } {@link JAXBElement }{@code <}{@link NumFacet }{@code >} {@link JAXBElement
   * }{@code <}{@link NumFacet }{@code >} {@link JAXBElement }{@code <}{@link Facet }{@code >}
   */
   ...
   * <p/>
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the returned list
   * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the attributeOrAttributeGroup property.
   * <p/>
   * <p/>
   * For example, to add a new item, do as follows:
   * 
