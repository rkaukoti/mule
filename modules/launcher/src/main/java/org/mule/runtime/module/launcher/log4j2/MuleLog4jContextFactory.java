...
/**
 * Implementation of {@link org.apache.logging.log4j.spi.LoggerContextFactory} which acts as the bootstrap for mule's logging mechanism.
 * <p/>
 ...
 * {@link org.mule.runtime.module.launcher.log4j2.AsyncLoggerExceptionHandler} as the {@link com.lmax.disruptor.ExceptionHandler} for
 * failing async loggers.
 * <p/>
 * Other than that, it's pretty much a copy paste of {@link org.apache.logging.log4j.core.impl.Log4jContextFactory}, due to that classes'
 * lack of extensibility.
 * <p/>
 * By forcing {@link org.apache.logging.log4j.core.config.xml.XmlConfigurationFactory} as the only available
 * {@link org.apache.logging.log4j.core.config.ConfigurationFactory} we're disabling log4j2's ability to take json and yaml configurations.
 * This is so because those configuration factories depend on versions of the jackson libraries which would cause conflict with the ones in
 * mule. TODO: Upgrade the jackson libraries bundled with mule so that this restriction can be lifted off
 *
 * @since 3.6.0
 */
