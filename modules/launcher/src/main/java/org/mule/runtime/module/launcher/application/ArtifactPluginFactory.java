...
public interface ArtifactPluginFactory {
  ...
  /**
   * Creates an {@link ArtifactPlugin} along with its classloader. The classloader for the application plugin would be a child classloader
   * of the given parent and it will use the same {@link ClassLoaderLookupPolicy} as the parent.
   *
