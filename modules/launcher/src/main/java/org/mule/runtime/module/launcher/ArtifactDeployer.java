...
public interface ArtifactDeployer<T extends DeployableArtifact> {
   ...
   * Deploys an artifact.
   *
   * The deployer executes the artifact installation phases until the artifact is deployed After this method call the Artifact will be
   * installed in the container and started.
   *
   ...
   *
   * The deployer executes the artifact desinstallation phases until de artifact is undeployed. After this method call the Artifact will not
   * longer be running inside the container.
   *
