                    ...
                    <xsl:choose>
                        <xsl:when test="@name!='JMImplementation'">
                            ...
                            <xsl:variable name="url"
                                          select="concat('invoke?operation=printHtmlSummary&amp;objectname=', @name, ':type=org.mule.Statistics,name=AllStatistics&amp;template=statistics')"/>
                            <a href="{$url}" class="serverbydomain_statistics" title="Domain Statistics">
