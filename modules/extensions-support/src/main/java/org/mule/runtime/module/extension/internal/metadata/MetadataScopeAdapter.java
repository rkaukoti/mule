...
/**
 * Adapter implementation which expands the {@link MetadataScope} to a more descriptive of the developer's metadata declaration for a
 * {@link ComponentModel component}
 *
 * @since 4.0
 */
