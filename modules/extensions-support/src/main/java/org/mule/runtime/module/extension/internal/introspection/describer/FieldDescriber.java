...
/**
 * A delegate object used to derived a {@link ParameterDeclarer} from a {@link Field}
 *
 * @since 4.0
 */
interface FieldDescriber {
  ...
  /**
   * Determines if {@code this} instance is capable of processing the given {@code field}
   *
