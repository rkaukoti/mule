...
/**
 * Represents a function that accepts a {@link MuleEvent} and evaluates a MEL expression that produces a result of the specified type using
 * a {@link TypeSafeExpressionValueResolver}.
 *
 * @since 4.0
 */
