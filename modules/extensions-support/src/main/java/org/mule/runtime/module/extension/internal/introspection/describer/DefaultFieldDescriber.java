...
/**
 * Default implementation of {@link FieldDescriber}, capable of handling all {@link Field}s in a generic way.
 * <p>
 * Although it can handle pretty much any field, it's not suitable for those which need special treatment.
 *
 * @since 4.0
 */
final class DefaultFieldDescriber implements FieldDescriber {
  ...
  public ParameterDeclarer describe(Field field, ParameterizedDeclarer declarer) {
    ...
    parameterDeclarer.ofType(fieldType).withExpressionSupport(getExpressionSupport(field))
