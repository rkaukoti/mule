...
/**
 * A builder capable of creating instances of a given {@link Class}, populating its attributes based on a list of {@link ValueResolver}s.
 * <p/>
 ...
 * </ul>
 * <p/>
 * Instances of this class are to be considered thread safe and reusable since the {@link #build(MuleEvent)} method can be invoked several
 * times on the same instance. Each time {@link #build(MuleEvent)} is invoked, the resolvers will be re evaluated with the given event.
 *
 * @since 3.7.0
 */
public interface ObjectBuilder<T> {
  ...
  /**
   * Returns a new instance of the specified class. The given {@link MuleEvent} will be used to obtain a value from each registered
   * {@link ValueResolver}
   *
