...
/**
 * Returns the value of the {@link ExtensionProperties#CONNECTION_PARAM} variable, which is expected to have been previously set on the
 * supplied {@link OperationContext}.
 * <p>
...
public class ConnectionArgumentResolver implements ArgumentResolver<Object> {
  ...
  /**
   * Returns the connection previously set on the {@code operationContext} under the key {@link ExtensionProperties#CONNECTION_PARAM}
   *
  ...
  public Object resolve(OperationContext operationContext) {
    ...
    try {
      ...
      throw new MuleRuntimeException(MessageFactory.createStaticMessage(String.format(
          "Error was found trying to obtain a connection to execute operation '%s' of extension '%s'",
