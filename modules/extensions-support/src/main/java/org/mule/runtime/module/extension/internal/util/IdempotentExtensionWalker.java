...
/**
 * A {@link ExtensionWalker} which assures that each component is visited only once, making it easy to handle the fact that some components
 * such as {@link OperationModel}, {@link SourceModel}, {@link ConnectionProviderModel}, etc, implement the flyweight pattern, which means
 * that the same instance might be present at different levels.
 * <p>
