...
/**
 * Extension of {@link MetadataKeyBuilder} which adds de capability of create {@link DefaultMetadataKey} with a configured {@code partName}
 *
 * @since 4.0
 */
public class PartAwareMetadataKeyBuilder extends MetadataKeyBuilder {
  ...
  /**
   * Creates and returns new instance of a {@link PartAwareMetadataKeyBuilder}, to help building a new {@link MetadataKey} represented by
   * the given {@param id}
   *
