...
/**
 * Base class for implementations of {@link ObjectBuilder}. It implements all of the contract's behavior, except for how to actually create
 * the instance to be returned. Implementors must provide that piece through the abstract {@link #instantiateObject()} method
 *
 * @since 3.7.0
 */
