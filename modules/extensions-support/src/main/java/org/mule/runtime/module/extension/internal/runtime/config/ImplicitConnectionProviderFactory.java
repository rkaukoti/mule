...
public interface ImplicitConnectionProviderFactory {
   ...
   * {@link ImplicitObjectUtils#getFirstImplicit(List)} on all the providers available to {@code configurationModel} (under the rules of
   ...
   * @throws IllegalArgumentException if the {@code extensionModel} doesn't have any {@link ConnectionProviderModel} which can be used
   *         implicitly
   */
