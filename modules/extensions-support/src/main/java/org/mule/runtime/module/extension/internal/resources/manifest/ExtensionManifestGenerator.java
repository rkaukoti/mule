...
public final class ExtensionManifestGenerator implements GeneratedResourceFactory {
  ...
  public Optional<GeneratedResource> generateResource(ExtensionModel extensionModel) {
    ...
    builder.setName(extensionModel.getName()).setDescription(extensionModel.getDescription()).setVersion(extensionModel.getVersion())
        .setMinMuleVersion(extensionModel.getMinMuleVersion()).addExportedPackages(exportCollector.getExportedPackages())
        .addExportedResources(exportCollector.getExportedResources()).withDescriber().setId(DESCRIBER_ID)
