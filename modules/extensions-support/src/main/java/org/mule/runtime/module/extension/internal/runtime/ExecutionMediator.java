...
/**
 * Executes operations while coordinating the several moving parts that are affected by the execution process, so that such pieces can
 * remain decoupled.
 * <p/>
 * This mediator will coordinate {@link OperationExecutor operation executors}, {@link Interceptor interceptors}, {@link RetryRequest},
