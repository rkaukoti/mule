 ...
 * <p>
 * In case the security manager has no name or the name is the same as the default one provided by the {@code MuleContext} then the
 * configured values will be added only to the security manager, otherwise a new security manager will be registered under the provided name
