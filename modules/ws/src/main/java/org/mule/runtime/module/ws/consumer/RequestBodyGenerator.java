...
public class RequestBodyGenerator {
  ...
  /**
   * Checks if the operation requires input parameters (if the XML required in the body is just one constant element). If so, the body with
   * this XML will be returned in order to send it in every request instead of the payload.
   */
  ...
  /**
   * Finds the part of the input message that must be used in the SOAP body, if the operation requires only one part. Otherwise returns
   * null.
   */
