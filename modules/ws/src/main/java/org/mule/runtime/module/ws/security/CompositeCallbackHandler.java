...
/**
 * Callback handler implementation that delegates the handle operation to a list of callback handlers. This allows to compose multiple
 * callback handler implementations to handle different types of callbacks.
 */
