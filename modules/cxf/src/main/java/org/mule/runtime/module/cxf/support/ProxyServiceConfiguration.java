...
public class ProxyServiceConfiguration extends DefaultServiceConfiguration {
  ...
  /**
   * Override to use port name from service definition in WSDL when we are doing WSDL-first. This is required so that CXF's internal
   * endpointName and port name match and a CXF Service gets created. See: https://issues.apache.org/jira/browse/CXF-1920
  ...
  /**
   * This method returns a list of all the services defined in the definition. Its current purpose is only for generating a better error
  ...
  /**
   * This method returns the list of services that matches with the local part of the service QName. Its current purpose is only for
   * generating a better error message when the service cannot be found.
   */
