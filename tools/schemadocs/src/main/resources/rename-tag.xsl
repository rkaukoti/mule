        ...
        <xsl:copy>
            ...
            <xsl:if test="@ref">
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:attribute name="ref">
                            <xsl:value-of select="concat($tag, ':', @ref)"/>
                        </xsl:attribute>
                    </xsl:otherwise>
                </xsl:choose>
            </xsl:if>
            <xsl:if test="@base">
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:attribute name="base">
                            <xsl:value-of select="concat($tag, ':', @base)"/>
                        </xsl:attribute>
                    </xsl:otherwise>
                </xsl:choose>
            </xsl:if>
            <xsl:if test="@type">
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:attribute name="type">
                            <xsl:value-of select="concat($tag, ':', @type)"/>
                        </xsl:attribute>
                    </xsl:otherwise>
                </xsl:choose>
            </xsl:if>
            <xsl:if test="@substitutionGroup">
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:attribute name="substitutionGroup">
                            <xsl:value-of select="concat($tag, ':', @substitutionGroup)"/>
                        </xsl:attribute>
                    </xsl:otherwise>
                </xsl:choose>
            </xsl:if>
