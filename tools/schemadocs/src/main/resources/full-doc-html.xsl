...
>
    ...
    <xsl:template match="xsd:element[@ref]">
        ...
        <xsl:comment>start element reference
        ...
        <xsl:comment>end element reference
            <xsl:value-of select="$elementRef"/>
        </xsl:comment>
    </xsl:template>
    ...
    <xsl:template match="xsd:complexType">
        ...
        <xsl:comment>start complexType
            <xsl:value-of select="$typeName"/>
        </xsl:comment>
        <xsl:call-template name="children"/>
        <xsl:comment>end complexType
            <xsl:value-of select="$typeName"/>
        </xsl:comment>
    </xsl:template>
    ...
    <xsl:template match="xsd:group">
        ...
        <xsl:comment>start group
            <xsl:value-of select="$groupName"/>
        </xsl:comment>
        <xsl:call-template name="children"/>
        <xsl:comment>end group
            <xsl:value-of select="$groupName"/>
        </xsl:comment>
    </xsl:template>
