 ...
 *
 * When the notification is to be sent on the context of the processing of a {@link MuleEvent} (meaning, the method used to fire the
 * notification takes a {@link MuleEvent} argument), then this instance will delegate into a {@link ServerNotificationHandler} that
 * corresponds to the {@link MuleContext} of that event. When the notification does not relate to a particular {@link MuleEvent} (for
...
public class NotificationHelper {
  ...
  /**
   * Checks if the {@link #defaultNotificationHandler} is enabled to fire instances of {@link #notificationClass}. Use this method when
   * planning to fire a notification that is not related to a {@link MuleEvent} (connect/disconnect/etc). Otherwise, use
  ...
  /**
   * Fires a {@link ConnectorMessageNotification} for the given arguments using the {@link ServerNotificationHandler} associated to the
   * given {@code event}
   *
  ...
  /**
   * Fires the given {@code notification} using the {@link #defaultNotificationHandler}. Use this method when the {@code notification} is
   * not related to any {@link MuleEvent} (for example, connect/disconnect/etc). Otherwise, use
  ...
  private void doFireNotification(ServerNotificationHandler serverNotificationHandler, Object source, MuleMessage message, String uri,
