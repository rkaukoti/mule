...
/**
 * Provides a strategy interface for reading information from an exception in a consistent way. For example JMS 1.0.2b uses linkedExceptions
 * rather that 'cause' and SQLExceptions hold additional information that can be extracted using this interface.
 */
