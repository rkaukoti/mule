...
/**
 * <code>NoSatisfiableMethodsException</code> is thrown by EntryPointResolvers when the service passed has no methods that meet the criteria
 * of the configured EntryPointResolver.
 *
