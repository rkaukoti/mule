...
public interface ReplyToHandler {
  ...
  /**
   * Processes replyTo in the case an exception occurred. Not all implementations will implement this if for example they should only send a
   * reply message in the sucess case.
   *
