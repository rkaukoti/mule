...
/**
 * RoundRobin divides the messages it receives among its target routes in round-robin fashion. The set of routes is obtained dynamically
 * using a {@link org.mule.runtime.core.routing.DynamicRouteResolver}
 * <p/>
