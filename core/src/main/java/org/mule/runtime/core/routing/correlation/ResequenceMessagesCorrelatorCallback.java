 ...
 * {@link #aggregateEvents(org.mule.runtime.core.routing.EventGroup)} method only resequences the events and returns an MuleEvent[] wrapped
 * in a MuleMessage impl. This means that this callback can ONLY be used with a {@link Resequencer}
 */
