...
/**
 * Is thrown explicitly when an expression is Malformed or invalid. Malformed means the syntax is not correct, but an expression can be
 * invalid if it refers to an expression namespace or function that does not exist
 */
