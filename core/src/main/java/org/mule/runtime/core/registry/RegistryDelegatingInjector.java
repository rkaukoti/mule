...
/**
 * An implementation of {@link Injector} which uses a {@link RegistryProvider} to look for {@link Registry} instances which also implement
 * {@link Injector}. The injection operation is then delegated into the first matching registry.
 *
