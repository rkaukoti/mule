...
public abstract class ThreadPoolFactory implements MuleContextAware {
  ...
  /**
   * By limitations of java's {@link ScheduledThreadPoolExecutor}, {@link ThreadingProfile#getMaxThreadsActive()} will be ignored and a
   * fixed pool with {@link ThreadingProfile#getMaxThreadsIdle()} will be created.
   */
