...
public final class DefaultConnectionManager implements ConnectionManagerAdapter, Lifecycle {
  ...
  private <Connection> ConnectionHandlingStrategyAdapter<Connection> getManagementStrategy(
    ...
    connectionHandlingStrategyFactory =
        new DefaultConnectionHandlingStrategyFactory<>(connectionProvider, poolingProfile, muleContext);
    return (ConnectionHandlingStrategyAdapter<Connection>) connectionProvider
        .getHandlingStrategy(connectionHandlingStrategyFactory);
  }
