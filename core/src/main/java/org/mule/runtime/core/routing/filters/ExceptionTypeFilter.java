...
/**
 * A filter that accepts messages that have an exception payload. An Exception type can also be set on this filter to allow it to accept
 * Exception messages of a particular Exception class only.
 */
