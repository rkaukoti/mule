...
/**
 * <code>EncryptionStrategyNotFoundException</code> is thrown by the SecurityManager when an encryption scheme is set in a property or
 * header that has not been registered witrh the manager
 */
