...
/**
 * Splits a message that has a map payload invoking the next message processor one for each item in the map in order. The Map entry value is
 * used as the new payload and the map key is set as a message property with the following property name 'key'.
 * <p>
