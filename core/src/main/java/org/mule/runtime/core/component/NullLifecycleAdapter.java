...
/**
 * <code>NullLifecycleAdapter</code> is a lifecycle adaptor implementation that performs no Mule lifecycle propagation to Mule service
 * component implementations. This can be used when the service component implementation is looked up from a container and therefore has
 * it's own lifecycle management.
 */
