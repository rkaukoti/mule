...
/**
 * <code>MuleRuntimeException</code> Is the base runtime exception type for the Mule Server any other runtimes exceptions thrown by Mule
 * code will use or be based on this exception. Runtime exceptions in mule are only ever thrown where the method is not declared to throw an
 * exception and the exception is serious.
 */
