...
/**
 * A container-managed lifecycle phase is called by the container itself. This class acts as a marker to enable tracking of phases even if
 * Mule does not initiate the phase
 *
