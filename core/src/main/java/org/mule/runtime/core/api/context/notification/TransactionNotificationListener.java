...
/**
 * <code>TransactionNotificationListener</code> is an observer interface that objects can implement and then register themselves with the
 * Mule manager to be notified when a Transaction event occurs.
 */
