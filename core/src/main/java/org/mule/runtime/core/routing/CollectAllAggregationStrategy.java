...
/**
 * If no routes generated exeption then it returns a new {@link MuleEvent} under the rules of {@link DefaultRouterResultsHandler} (you can
 * change this behaviour by overriding {@link #aggregateWithoutFailedRoutes(AggregationContext)}. Otherwise, a
