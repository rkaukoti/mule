...
public abstract class AbstractRegistry implements Registry {
  ...
  /**
   * Template method for the logic to actually unregister the key without applying any lifecycle to it. Applying the shutdown lifecycle will
   * be up to {@link #unregisterObject(String)}
   *
