...
/**
 * Extension of {@link FlowProcessingPhaseTemplate} for those {@link org.mule.runtime.core.api.source.MessageSource} that requires sending a
 * response of the message processed.
 */
