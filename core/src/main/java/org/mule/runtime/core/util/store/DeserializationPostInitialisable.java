...
/**
 * A marker interface used to trigger post-deserialization initialization of an object. This works in the same way as {@link Cloneable}
 * interface. Implementors of this interface must add the method
 * <code>private void initAfterDeserialization(MuleContext muleContext) throws MuleException</code> to their class (note that it's private).
