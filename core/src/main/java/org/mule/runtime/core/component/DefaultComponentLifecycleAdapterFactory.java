 ...
 * LifeCycleAdapter factories to control lifecycle events on their services such as introduce other lifecycle events that are controlled by
 * external changes.
 *
...
public class DefaultComponentLifecycleAdapterFactory implements LifecycleAdapterFactory<JavaComponent> {
  ...
  @Override
  public LifecycleAdapter create(Object pojoService, JavaComponent component, FlowConstruct flowConstruct, EntryPointResolverSet resolver,
