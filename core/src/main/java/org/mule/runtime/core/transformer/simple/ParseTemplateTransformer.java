...
/**
 * Loads a template and parses its content to resolve expressions. The order in which attempts to load the resource is the following: from
 * the file system, from a URL or from the classpath.
 */
