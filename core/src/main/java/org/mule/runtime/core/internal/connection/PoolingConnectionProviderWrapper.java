 ...
 * <p/>
 * The purpose of this wrapper is having the {@link #getHandlingStrategy(ConnectionHandlingStrategyFactory)} method use the
 * configured {@link #poolingProfile} instead of the default included in the {@link #delegate}
 * <p/>
 *
 * @since 4.0
 */
