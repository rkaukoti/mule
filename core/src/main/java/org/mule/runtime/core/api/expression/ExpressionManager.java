...
public interface ExpressionManager
{
     ...
     * @throws ExpressionRuntimeException if the expression is invalid, or a null is found for the expression and 'failIfNull is set to
     *                                    true.
     */
     ...
     * @param expression a single expression i.e. xpath://foo
     * @param event      The current event being processed
     * @param failIfNull determines if an exception should be thrown if expression could not be evaluated or returns null. @return the
