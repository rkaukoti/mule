...
public interface ExpressionManager {
   ...
   * be parsed within a single text, the {@link #parse(String, org.mule.runtime.core.api.MuleEvent, boolean)} method should be
   * used since it will iterate through all expressions in a string.
   *
