...
/**
 * Allows for arguments with no parameters to be called. Regardless of the payload of the current event, this resolver will always only look
 * for No-Arg servic methods.
 * <p/>
 * Note that the {@link org.mule.runtime.core.model.resolvers.ReflectionEntryPointResolver} supports the resolution of no-arg service
 * methods if the event payload received is of type {@link org.mule.runtime.api.message.NullPayload}.
 *
