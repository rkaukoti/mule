...
public interface ConnectionManagerAdapter extends ConnectionManager, Stoppable {
  ...
  /**
   * When no {@link RetryPolicyTemplate} is specified by the user the {@link ConnectionManagerAdapter} will provide the default one to
   * create the required {@link RetryPolicy}s instances.
   *
  ...
  /**
   * When no {@link PoolingProfile} is specified by the user the {@link ConnectionManagerAdapter} will provide the default one to configure
