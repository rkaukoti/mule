...
public class MvelDataTypeResolver
{
     ...
     * @return the data type corresponding to the given expression if there is an expression resolver able to resolved it. A default data
     * type for the value if the expression was not resolved.
     */
