...
/**
 * Configure indirect key stores. TLS/SSL connections are made on behalf of an entity, which can be anonymous or identified by a certificate
 ...
 *
 * <p>
 * The information specified in this interface is used to configure a key store indirectly. For more information see the documentation for
 * the connector or protocol in question. The comments in {@link org.mule.runtime.core.api.security.tls.TlsConfiguration} may also be
 * useful.
 * </p>
 *
 * <p>
 ...
 * interface implemented by {@link org.mule.runtime.core.api.security.tls.TlsConfiguration}. This can be associated with a socket factory
 * via {@link org.mule.runtime.core.api.security.tls.TlsPropertiesSocketFactory}.
 * </p>
 */
