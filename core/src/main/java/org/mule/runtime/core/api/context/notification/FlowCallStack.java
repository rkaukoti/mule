...
public interface FlowCallStack extends Serializable, Cloneable {
  ...
  /**
   * @return the current elements of this stack as a list, ordered from top to bottom, if {@link DefaultMuleConfiguration#isFlowTrace()} is
   *         {@code true}. Empty list otherwise.
   */
