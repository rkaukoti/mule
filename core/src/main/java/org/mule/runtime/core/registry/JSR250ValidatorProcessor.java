 ...
 * <ol>
 * <li>The method MUST NOT have any parameters except in the case of EJB interceptors in which case it takes an InvocationContext object as
 * defined by the EJB specification. Note that Mule is not an EJB container so the EJB case is ignored in Mule.</li>
 ...
 * <li>The method MAY be final or non-final, except in the case of EJBs where it MUST be non-final. Note that Mule is not an EJB container
 * so the EJB case is ignored in Mule.</li>
 * </ol>
 *
