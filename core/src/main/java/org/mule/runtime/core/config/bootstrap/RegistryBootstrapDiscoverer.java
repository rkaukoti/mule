...
/**
 * Allows to discover properties to be used during the bootstrap process. Implementing this interface you will be able to customize which
 * Properties are taken into account at the bootstrap process, and the order they are processed.
 */
