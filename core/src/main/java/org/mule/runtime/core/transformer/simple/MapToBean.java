...
/**
 * Creates and object of type {@code getReturnDataType().getType()} and populates values of a {@link java.util.Map} as bean properties on
 * the object. The bean class name can also be passed in as a property on the Map (which gets removed once read). The
 * {@link MapToBean#CLASS_PROPERTY} should be set as a fully qualified class name string.
 */
