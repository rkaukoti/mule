 ...
 * <p/>
 * When {@link #transform(Object)} is called each converter in the same order they are included in the composition. The output of a given
 * converter is the input of the next composed converter.
 */
