...
/**
 * <code>AbstractCompressionTransformer</code> is a base class for all transformers that can compress or uncompress data when they performa
 * message transformation. Compression is done via a pluggable strategy.
 */
