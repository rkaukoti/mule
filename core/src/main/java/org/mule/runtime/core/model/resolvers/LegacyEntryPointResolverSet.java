...
/**
 * An {@link org.mule.runtime.core.api.model.EntryPointResolverSet} that mimics the behaviour of the Mule 1.x DynamicEntryPointResolver.
 * <b>NOTE:</b> Since 3.0 this legacy entry point resolver will always invoked after message transformation and not before.
 */
