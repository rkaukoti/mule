...
/**
 * Utility class to log a warning message only once during the lifecycle of a component. The {@link #warn()} message will log that message
 * only once, in a thread-safe manner. This component is conceived with the intent of allowing deprecated components to warn that they
