...
public interface OutboundRouter
  ...
  /**
   * Sets the replyTo route for any outgoing messages. This will then be used by other Mule routers to send replies back for this
   * message. If the underlying protocol supports replyTo messages, such as Jms, a Jms Destination will be attached to the
   * outbound message
   *
