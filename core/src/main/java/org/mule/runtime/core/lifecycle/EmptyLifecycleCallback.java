...
/**
 * A lifecycle callback that does nothing. Can be used to transition a {@link org.mule.runtime.core.api.lifecycle.LifecycleManager} to the
 * next phase without executing logic.
 *
