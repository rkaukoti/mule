...
/**
 * <code>FatalException</code> can be thrown during initialisation or during execution to indicate that something fatal has occurred and the
 * MuleManager must shutdown.
 */
