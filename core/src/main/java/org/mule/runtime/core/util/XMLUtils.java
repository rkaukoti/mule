...
/**
 * These only depend on standard (JSE) XML classes and are used by Spring config code. For a more extensive (sub-)class, see the XMLUtils
 * class in the XML module.
 */
