 ...
 *
 * When an exception is thrown in a message processor, implementations of this interface will be called in order to augment the exception
 * message with properties that can be helpful to an application developer troubleshooting that exception.
 *
 * @since 3.8.0
 */
