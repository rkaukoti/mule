...
public interface ServiceRegistry
{
     ...
     * @param loader        the class loader to be used to load provider/configuration files and instantiate provider instances. If {@code
     *                      null}, it will be up to the implementation to choose a {@link ClassLoader}
