...
/**
 * <code>TooManySatisfiableMethodsException</code> is thrown by EntryPointResolvers when the service passed has more than one method that
 * meets the criteria of the configured EntryPointResolver.
 *
