...
public final class XMLEntityCodec
{
    ...
    private static class Entities
    {
        ...
        private static class IntHashMap
        {
             ...
             * @return <code>true</code> if and only if some key maps to the <code>value</code> argument in this hashtable as determined by
             ...
             * @return the value to which the key is mapped in this hashtable; <code>null</code> if the key is not mapped to any value in
             * this hashtable.
             * @see #put(int, Object)
             */
