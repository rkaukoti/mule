...
/**
 * A {@link ConnectionHandlingStrategyAdapter} which lazily creates and caches connections, so that the same instance is returned
 * each time that one is required.
 * <p/>
