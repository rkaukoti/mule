...
public interface SocketConnection {
  ...
  /**
   * Disconnects the connection. Does nothing if the connection was not previously connected. If an error occur while disconnecting, it will
   * be logged with an ERROR level and the disconnection will continue.
   */
  void disconnect();
