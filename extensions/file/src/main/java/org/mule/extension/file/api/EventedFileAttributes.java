 ...
 * <p>
 * Because a {@link FileAttributes} is a snapshot of a file's attributes at a specific point of time, the purpose of this class is to
 * associate such state to a particular event type which took it into that state
 *
 * @since 4.0
 */
