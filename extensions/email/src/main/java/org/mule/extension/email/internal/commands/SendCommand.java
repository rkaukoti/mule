...
public final class SendCommand {
  ...
  /**
   * Send an email message. The message will be sent to all recipient {@code toAddresses}, {@code ccAddresses}, {@code bccAddresses}
   ...
   */
  public void send(SenderConnection connection, EmailContent content, String subject, List<String> toAddresses, String fromAddress,
      String defaultCharset, List<String> ccAddresses, List<String> bccAddresses, Map<String, String> headers,
