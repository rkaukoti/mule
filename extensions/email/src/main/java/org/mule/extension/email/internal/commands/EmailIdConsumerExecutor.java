 ...
 * <p>
 * This class is the responsible for looking in the incoming message if there are one or more emailIds to accept and perform the operation
...
public class EmailIdConsumerExecutor {
   ...
   * <p>
   * If no explicit {@code emailId} is provided and this method is not able to find any emailIds in the incoming {@link MuleMessage} the
   * execution of the {@link Consumer} will fail.
   */
