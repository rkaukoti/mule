...
/**
 * This {@link EmailRetrieverException} is the base {@link RuntimeException} type for operations that retrieves emails any other exceptions
 * thrown by operations that retrieves emails will be wrapped into one of this.
 *
 * @since 4.0
 */
