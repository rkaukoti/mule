...
public final class ForwardCommand {
   ...
   * <p>
   * The forwarded content is taken from the incoming {@link MuleMessage}'s payload. If not possible this operation is going to fail.
   *
  ...
  public void forward(SenderConnection connection, MuleMessage muleMessage, EmailContent content, String subject, String from,
      String defaultCharset, List<String> toAddresses, List<String> ccAddresses, List<String> bccAddresses, Map<String, String> headers) {
