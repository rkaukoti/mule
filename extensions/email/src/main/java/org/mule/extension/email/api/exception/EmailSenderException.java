...
/**
 * This {@link EmailSenderException} is the base {@link RuntimeException} type for operations that sends emails any other exceptions thrown
 * by operations that sends emails will be wrapped into one of this.
 *
 * @since 4.0
 */
