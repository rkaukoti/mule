...
/**
 * A specialization of {@link FilePredicateBuilder} used to do assertions on files stored on an FTP server. The file's properties are to be
 * represented on an instance of {@link FtpFileAttributes}
 * <p>
