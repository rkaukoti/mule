...
/**
 * Response validator that allows specifying which status codes should be treated as failures. Responses with such status codes will cause
 * the component to throw an exception.
 *
 * @since 4.0
 */
