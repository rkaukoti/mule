...
/**
 * Validates that {@link #value} is not empty. The definition of empty depends on the type of {@link #value}. If it's a {@link String} it
 * will check that it is not blank. If it's a {@link Collection}, array or {@link Map} it will check that it's not empty. No other types are
