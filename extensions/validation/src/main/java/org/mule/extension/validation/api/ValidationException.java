...
/**
 * The exception to be thrown by default when a validation fails. It's a pretty simple {@link MuleException} with the added ability to
 * provide the {@link ValidationResult} which failed.
 * <p/>
