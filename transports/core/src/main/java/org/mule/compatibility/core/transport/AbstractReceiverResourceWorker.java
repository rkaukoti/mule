...
/**
 * This is a Message receiver worker used by transports that do not have a way for the underlying transport to call back to the receiver
 * when a message is available such as Jms. This worker provides a callback {@link #getNextMessage(Object)} where the receiver can read the
 * next message from the underlying transport.
 */
