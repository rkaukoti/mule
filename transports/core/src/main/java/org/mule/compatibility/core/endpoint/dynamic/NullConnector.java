...
/**
 * A placeholder for a connector that has not been created yet. This used by dynamic endpoints who's actual endpoint is not created until
 * the first message is received for processing. At that point the real endpoint is created and the 'NullEndpoint' including this
 * NullConnector is overwritten.
 *
