...
/**
 * <code>MessageTypeNotSupportedException</code> is thrown when a {@link MuleMessage} instance is to be created with an payload type that is
 * not of supported type by that {@link MuleMessageFactory}.
 *
