...
public interface MessageRequesterFactory
{
     ...
     * automatically disposed of and a new one is created for the next request. This allows requesters to recover from loss of connection
     * and other faults. When invoked by {@link #validate(org.mule.compatibility.core.api.endpoint.InboundEndpoint,
     * org.mule.compatibility.core.api.transport.MessageRequester)} it takes precedence over the dispatcher's own return value of {@link
     * org.mule.compatibility.core.api.transport.MessageDispatcher#validate()}.
     *
     ...
     * pool via {@link #passivate(org.mule.compatibility.core.api.endpoint.InboundEndpoint, org.mule.compatibility.core.api.transport.MessageRequester)}.
     *
     * @param endpoint  the endpoint of the requester
    ...
    /**
     * Invoked when a requester returned <code>false</code> for {@link #validate(org.mule.compatibility.core.api.endpoint.InboundEndpoint,
     * org.mule.compatibility.core.api.transport.MessageRequester)}.
     *
     * @param endpoint  the endpoint of the requester
     * @param requester the requester to be validated
     */
