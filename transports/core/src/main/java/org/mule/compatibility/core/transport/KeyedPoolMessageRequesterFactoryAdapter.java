...
/**
 * <code>KeyedPoolMessageRequesterFactoryAdapter</code> adapts a <code>MessageRequesterFactory</code> with methods from commons-pool
 * <code>KeyedPoolableObjectFactory</code>. It is only required for requester factories that do not inherit from
