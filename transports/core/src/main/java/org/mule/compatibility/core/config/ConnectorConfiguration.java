...
public class ConnectorConfiguration {
  ...
  /**
   * For the cases where HTTP needs to be used by default (no connector or endpoint is explicitly defined), this determines if the old HTTP
   * transport should be used by default. If false, the new HTTP connector will be used. This applies, for example, when specifying an HTTP
   * URI in MuleClient.
   */
  private boolean useTransportForUris() {
