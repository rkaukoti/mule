...
/**
 * <code>ConnectorException</code> Is thrown in the context of a Connector, usually some sort of transport level error where the connection
 * has failed. This exception maintains a reference to the connector.
 *
 * @see Connector
