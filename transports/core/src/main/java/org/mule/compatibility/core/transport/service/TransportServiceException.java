...
/**
 * <code>TransportServiceException</code> is thrown if a ProviderServicedescriptor has a service error set. This is usually because the
 * endpoint/connector cannot be created from a service descriptor
 */
