...
public class HttpDateTestCase extends AbstractMuleTestCase {
  ...
  public void testParsingBackwardsCompatibility() {
    ...
    String[] dates = new String[] {"Tue, 15 Nov 1994 08:12:31 GMT", "Tue, 15 Nov 1994 08:12:31 -0300", "Tue, 15 Nov 1994 08:12:31 +0400",
    ...
    for (String date : dates) {
      ...
      try {
        ...
        fail("Old formatter failed to parse output of new formatter so it isn't backwards compatible. original: " + date + " new: "
            + newDateStr);
      }
    }
  }
