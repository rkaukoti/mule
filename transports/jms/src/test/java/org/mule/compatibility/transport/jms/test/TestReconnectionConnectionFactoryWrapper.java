...
/**
 * Interface for testing JMS reconnections. Implementing classes should extend a particular JMS providers ConnectionFactory and throw a JMS
 * exception when isEnabled() == false and the mule server is trying to connect to it.
 */
