...
/**
 * Test all combinations of (inbound) JOIN_IF_POSSIBLE. They should all pass, except for ALWAYS_JOIN on the outbound endpoint, since no
 * transaction should be created by JOIN_IF_POSSIBLE.
 */
public class JmsSingleTransactionSingleServiceJoinIfPossibleConfigurationTestCase
  ...
  public void testAlwaysJoin() throws Exception {
    ...
    /*
     * scenarioCommit.setInputDestinationName(JMS_QUEUE_INPUT_CONF_D); scenarioRollback.setInputDestinationName(JMS_QUEUE_INPUT_CONF_D);
     * scenarioNotReceive.setInputDestinationName(JMS_QUEUE_INPUT_CONF_D); scenarioCommit.setOutputDestinationName(JMS_QUEUE_OUTPUT_CONF_D);
