...
/**
 * Decorates the jms ConnectionFactory with a {@link org.mule.compatibility.transport.jms.xa.DefaultXAConnectionFactoryWrapper} in order to
 * avoid releasing jms resources before the XA transaction has ended.
 */
