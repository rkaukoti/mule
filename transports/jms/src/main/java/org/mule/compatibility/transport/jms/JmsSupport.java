...
/**
 * <code>JmsSupport</code> is an interface that provides a polymorphic facade to the JMS 1.0.2b and 1.1 API specifications. this interface
 * is not intended for general purpose use and should only be used with the Mule JMS connector.
 */
...
public interface JmsSupport {
  ...
  MessageConsumer createConsumer(Session session, Destination destination, String messageSelector, boolean noLocal, String durableName,
