...
public class JmsTransportComponentBuildingDefinitionProvider extends TransportComponentBuildingDefinitionProvider
{
    ...
    public List<ComponentBuildingDefinition> getComponentBuildingDefinitions()
    {
        ...
        componentBuildingDefinitions.add(baseJmsConnector.copy()
                                                         .withIdentifier("custom-connector")
                                                         .withTypeDefinition(fromConfigurationAttribute("class"))
                                                         .build());

        componentBuildingDefinitions.add(baseJmsConnector.copy()
                                                         .withIdentifier("weblogic-connector")
                                                         .withTypeDefinition(fromType(WeblogicJmsConnector.class))
                                                         .build());

        componentBuildingDefinitions.add(baseJmsConnector.copy()
                                                         .withIdentifier("websphere-connector")
                                                         .withTypeDefinition(fromType(WebsphereJmsConnector.class))
                                                         .build());
        ...
        ComponentBuildingDefinition.Builder baseActiveMqConnector = baseJmsConnector.copy()
                                                                                    ...
                                                                                    .withSetterParameterDefinition("brokerURL",
                                                                                            fromSimpleParameter("brokerURL").build());
        ...
        componentBuildingDefinitions.add(baseDefinition.copy()
                                                       ...
                                                       .withSetterParameterDefinition("jndiInitialFactory",
                                                               fromSimpleParameter("jndiInitialFactory").build())
                                                       .withSetterParameterDefinition("jndiProviderUrl",
                                                               fromSimpleParameter("jndiProviderUrl").build())
        ...
        componentBuildingDefinitions.add(baseDefinition.copy()
                                                       ...
                                                       .withSetterParameterDefinition("expression",
                                                               fromSimpleParameter("expression").build()).build());

        componentBuildingDefinitions.add(getBaseTransactionDefinitionBuilder().copy()
                                                                              .withNamespace(JMS_NAMESPACE)
                                                                              .withSetterParameterDefinition("factory",
                                                                                      fromFixedValue(new JmsTransactionFactory()).build())
                                                                              .build());
        ...
        componentBuildingDefinitions.add(getBaseTransactionDefinitionBuilder().copy()
                                                                              ...
                                                                              .withSetterParameterDefinition("factory", fromFixedValue(
                                                                                      new JmsClientAcknowledgeTransactionFactory()).build())
                                                                              .build());
        ...
        componentBuildingDefinitions.add(baseDefinition.copy()
                                                       ...
                                                       .withSetterParameterDefinition("sessionCacheSize",
                                                               fromSimpleParameter("sessionCacheSize").build())
                                                       .withSetterParameterDefinition("cacheProducers",
                                                               fromSimpleParameter("cacheProducers").build())
                                                       .withSetterParameterDefinition("username", fromSimpleParameter("username").build())
                                                       .withSetterParameterDefinition("password", fromSimpleParameter("password").build())
                                                       .withSetterParameterDefinition("connectionFactory",
                                                               fromSimpleReferenceParameter("connectionFactory-ref").build())
                                                       .build());
