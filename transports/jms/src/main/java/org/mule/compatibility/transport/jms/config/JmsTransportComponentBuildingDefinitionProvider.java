...
public class JmsTransportComponentBuildingDefinitionProvider extends TransportComponentBuildingDefinitionProvider {
  ...
  public List<ComponentBuildingDefinition> getComponentBuildingDefinitions() {
    ...
    componentBuildingDefinitions
        .add(baseJmsConnector.copy().withIdentifier("custom-connector").withTypeDefinition(fromConfigurationAttribute("class")).build());

    componentBuildingDefinitions
        .add(baseJmsConnector.copy().withIdentifier("weblogic-connector").withTypeDefinition(fromType(WeblogicJmsConnector.class)).build());

    componentBuildingDefinitions.add(
        baseJmsConnector.copy().withIdentifier("websphere-connector").withTypeDefinition(fromType(WebsphereJmsConnector.class)).build());
    ...
    componentBuildingDefinitions.add(
        baseActiveMqConnector.copy().withIdentifier("activemq-connector").withTypeDefinition(fromType(ActiveMQJmsConnector.class)).build());
    ...
    componentBuildingDefinitions
        .add(baseDefinition.copy().withIdentifier("default-jndi-name-resolver").withTypeDefinition(fromType(SimpleJndiNameResolver.class))
            .withSetterParameterDefinition("jndiInitialFactory", fromSimpleParameter("jndiInitialFactory").build())
            .withSetterParameterDefinition("jndiProviderUrl", fromSimpleParameter("jndiProviderUrl").build())
            .withSetterParameterDefinition("jndiProviderProperties", fromSimpleReferenceParameter("jndiProviderProperties-ref").build())
            .build());
    ...
    componentBuildingDefinitions.add(
        baseDefinition.copy().withIdentifier("custom-jndi-name-resolver").withTypeDefinition(fromConfigurationAttribute("class")).build());

    componentBuildingDefinitions.add(baseDefinition.copy().withIdentifier("selector").withTypeDefinition(fromType(JmsSelectorFilter.class))
    ...
    componentBuildingDefinitions
        .add(getBaseTransactionDefinitionBuilder().copy().withNamespace(JMS_NAMESPACE).withIdentifier("client-ack-transaction")
    ...
    componentBuildingDefinitions.add(baseDefinition.copy().withIdentifier("caching-connection-factory")
        .withTypeDefinition(fromType(CachingConnectionFactory.class)).withObjectFactoryType(CachingConnectionFactoryFactoryBean.class)
        ...
        .withSetterParameterDefinition("username", fromSimpleParameter("username").build())
        .withSetterParameterDefinition("password", fromSimpleParameter("password").build())
        .withSetterParameterDefinition("connectionFactory", fromSimpleReferenceParameter("connectionFactory-ref").build()).build());
