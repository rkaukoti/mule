...
/**
 * Test transaction behavior when "joinExternal" is set to disallow joining external transactions There is one test per legal transactional
 * behavior (e.g. ALWAYS_BEGIN).
 */
