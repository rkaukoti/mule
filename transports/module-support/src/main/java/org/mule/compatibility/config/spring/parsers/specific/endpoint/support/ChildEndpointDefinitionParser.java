...
/**
 * A parser for "embedded" endpoints - ie inbound, outbound and response endpoints. Because we have automatic String -> MuleEnpointURI
 * conversion via property editors this can be used in a variety of ways. It should work directly with a simple String address attribute or,
