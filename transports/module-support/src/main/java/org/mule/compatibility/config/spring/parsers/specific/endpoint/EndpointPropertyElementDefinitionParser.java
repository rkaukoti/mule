...
/**
 * This parser parses nested endpoint elements adding the resulting beans to the map of properties on the EndpointBuilder rather than
 * attempting to inject them on the EndpointBuilder itself.
 */
