...
public class TransportComponentBuildingDefinitionProvider implements ComponentBuildingDefinitionProvider
{
    ...
    public List<ComponentBuildingDefinition> getComponentBuildingDefinitions()
    {
        ...
        componentBuildingDefinitions.add(baseDefinition.copy()
                                                       ...
                                                       .withSetterParameterDefinition("messageReceiver",
                                                               fromSimpleParameter("messageReceiver").build())
                                                       .withSetterParameterDefinition("transactedMessageReceiver",
                                                               fromSimpleParameter("transactedMessageReceiver").build())
                                                       .withSetterParameterDefinition("xaTransactedMessageReceiver",
                                                               fromSimpleParameter("xaTransactedMessageReceiver").build())
                                                       .withSetterParameterDefinition("dispatcherFactory",
                                                               fromSimpleParameter("dispatcherFactory").build())
                                                       .withSetterParameterDefinition("inboundTransformer",
                                                               fromSimpleParameter("inboundTransformer").build())
                                                       .withSetterParameterDefinition("outboundTransformer",
                                                               fromSimpleParameter("outboundTransformer").build())
                                                       .withSetterParameterDefinition("responseTransformer",
                                                               fromSimpleParameter("responseTransformer").build())
                                                       .withSetterParameterDefinition("endpointBuilder",
                                                               fromSimpleParameter("endpointBuilder").build())
                                                       .withSetterParameterDefinition("messageFactory",
                                                               fromSimpleParameter("messageFactory").build())
                                                       .withSetterParameterDefinition("serviceFinder",
                                                               fromSimpleParameter("serviceFinder").build())
                                                       .withSetterParameterDefinition("sessionHandler",
                                                               fromSimpleParameter("sessionHandler").build())
                                                       .withSetterParameterDefinition("inboundExchangePatterns",
                                                               fromSimpleParameter("inboundExchangePatterns").build())
                                                       .withSetterParameterDefinition("outboundExchangePatterns",
                                                               fromSimpleParameter("outboundExchangePatterns").build())
                                                       .withSetterParameterDefinition("defaultExchangePattern",
                                                               fromSimpleParameter("defaultExchangePattern").build())
                                                       .build());
    ...
    protected ComponentBuildingDefinition.Builder getOutboundEndpointBuildingDefinitionBuilder()
    {
        return baseDefinition.copy()
                             ...
                             .withSetterParameterDefinition("deleteUnacceptedMessages",
                                     fromSimpleParameter("deleteUnacceptedMessages").build())
                             ...
                             .withSetterParameterDefinition("disableTransportTransformer",
                                     fromSimpleParameter("disableTransportTransformer").build())
                             ...
                             .withSetterParameterDefinition("redeliveryPolicy",
                                     fromChildConfiguration(AbstractRedeliveryPolicy.class).build());
    }
    ...
    protected ComponentBuildingDefinition.Builder getBaseTransactionDefinitionBuilder()
    {
        return baseDefinition.copy()
                             ...
                             .withSetterParameterDefinition("action",
                                     fromSimpleParameter("action", getTransactionActionTypeConverter()).build());
    }
