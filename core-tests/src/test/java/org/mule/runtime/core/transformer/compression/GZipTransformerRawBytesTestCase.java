...
public class GZipTransformerRawBytesTestCase extends GZipTransformerTestCase {
  ...
  public void doTestBadReturnType(Transformer tran, Object src) throws Exception {
    /*
     * Disabled, otherwise the test for invalid return types would fail. The "invalid" class that is configured as returnType by the test
     * harness would actually be a valid return type for our roundTripTransformer.
     */
  }
